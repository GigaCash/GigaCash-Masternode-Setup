...
COIN_TGZ='https://github.com/GigaCash/GigaCash-Masternode-Setup/blob/master/gigacash.tar.gz'
...
function ask_permission() {
 echo -e "${RED}I trust Gigacash and want to use$ $COIN_NAME binaries compiled on his server.${NC}."
